...
break;
case 25:
 this.$ = p.parseFuncBlock(this._$, PrivateAccess, p.parseFuncDecl(this._$, p.parseId(this._$, '@main')), $$[$0]); 
break;
case 28:
 this.$ = p.parseFuncDecl(this._$, $$[$0], null, null, null); 
break;
case 29: case 37:
 this.$ = p.parseFuncDecl(this._$, $$[$0-2], null, null, null); 
break;
case 30:
 this.$ = p.parseFuncDecl(this._$, $$[$0-4], null, null, $$[$0]); 
break;
case 31:
 this.$ = p.parseFuncDecl(this._$, $$[$0-4], null, $$[$0], null); 
break;
case 32:
 this.$ = p.parseFuncDecl(this._$, $$[$0-6], null, $$[$0-2], $$[$0]); 
break;
case 33: case 38:
 this.$ = p.parseFuncDecl(this._$, $$[$0-3], $$[$0-1]); 
break;
case 34:
 this.$ = p.parseFuncDecl(this._$, $$[$0-5], $$[$0-3], null, $$[$0]); 
break;
case 35:
 this.$ = p.parseFuncDecl(this._$, $$[$0-5], $$[$0-3], $$[$0], null); 
break;
case 36:
 this.$ = p.parseFuncDecl(this._$, $$[$0-7], $$[$0-5], $$[$0-2], $$[$0]); 
break;
case 39:
 this.$ = p.parseFuncDecl(this._$, null, $$[$0-1], null, null); 
break;
case 40:
 this.$ = p.parseFuncDecl(this._$, null, $$[$0-3], null, $$[$0]); 
break;
case 41:
 this.$ = p.parseFuncDecl(this._$, null, $$[$0-3], $$[$0], null); 
break;
case 42:
 this.$ = p.parseFuncDecl(this._$, null, $$[$0-5], $$[$0-2], $$[$0]); 
break;
case 43:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-1], "+pos")); 
break;
case 44:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-1], "-neg")); 
break;
case 45:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-1], "!")); 
break;
case 46:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-1], "in this")); 
break;
case 47:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-1], $$[$0-1]), p.parseSet(_$[$0], $$[$0])); 
break;
case 48:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-2], ops.Index.token), p.parseSet(_$[$0-1], $$[$0-1])); 
break;
case 49:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-4], ops.IndexAssign.token),
                               p.parseSet(_$[$0-3], $$[$0-3]).append($$[$0])); 
break;
case 50:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-3], ops.IndexDelete.token), p.parseSet(_$[$0-1], $$[$0-1])); 
break;
case 51:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-6], ops.Slice.token), p.parseSet(_$[$0-5], $$[$0-5]).append($$[$0-3]).append($$[$0-1])); 
break;
case 52:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-8], ops.SliceAssign.token),
                               p.parseSet(_$[$0-7], $$[$0]).append($$[$0-7]).append($$[$0-5]).append($$[$0-3])); 
break;
case 53:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-7], ops.SliceDelete.token), p.parseSet(_$[$0-5], $$[$0-5]).append($$[$0-3]).append($$[$0-1])); 
break;
case 54:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-3], ops.Lookup.token), p.parseSet(_$[$0-1], $$[$0-1])); 
break;
case 55:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-5], ops.LookupAssign.token),
                               p.parseSet(_$[$0-3], $$[$0-3]).append($$[$0])); 
break;
case 56:
 this.$ = p.parseFuncDecl(this._$, p.parseId(_$[$0-4], ops.LookupDelete.token), p.parseSet(_$[$0-1], $$[$0-1])); 
break;
case 57: case 58: case 59: case 60: case 61: case 62: case 63: case 64: case 65: case 66: case 67: case 68: case 69: case 70: case 71: case 72: case 73: case 74: case 75: case 76: case 77: case 78: case 110:
 this.$ = $$[$0]; 
break;
