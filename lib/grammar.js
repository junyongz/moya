...
case 1:
 return $$[$0]; 
break;
case 2: case 7: case 113: case 163: case 301: case 371:
 this.$ = null; 
break;
...
break;
case 5: case 6: case 70: case 90: case 112: case 117: case 164: case 183: case 300: case 372:
 this.$ = $$[$0-1]; 
break;
case 12:
...
case 49:
 this.$ = p.parseOpFunc(this._$, ops.SliceAssign,
                               p.parseSet(_$[$0], $$[$0]).append($$[$0-7]).append($$[$0-5]).append($$[$0-3])); 
break;
case 50:
...
case 67: case 95: case 373:
 this.$ = [$$[$0]]; 
break;
case 68: case 96: case 374:
 this.$ = $$[$0-2]; $$[$0-2].push($$[$0]); 
break;
case 71: case 94: case 392:
...
break;
case 116: case 239: case 284: case 378:
...
break;
case 124:
 this.$ = p.parseBlock(this._$, $$[$0-2], p.ensureSet(_$[$0], $$[$0])); 
break;
...
break;
case 133: case 210: case 221: case 234:
...
break;
case 138: case 213: case 222: case 235:
...
break;
case 143: case 216: case 223: case 236:
 this.$ = p.parseMapper(this._$, $$[$0-2], null, $$[$0], false, false); 
break;
case 144: case 217: case 224: case 237:
 this.$ = p.parseMapper(this._$, $$[$0-4], $$[$0-2], $$[$0], false, $$[$0-3]); 
break;
case 147:
 this.$ = p.parseBlock(_$[$0-2], p.ensureSet(_$[$0-2], $$[$0-2]), p.ensureSet(_$[$0], $$[$0])); 
break;
case 148:
 this.$ = p.parseBlock(_$[$0-2], p.ensureSet(_$[$0-2], $$[$0-2]), $$[$0]); 
break;
case 150:
...
break;
case 155:
 this.$ = p.parseBlock(this._$, p.ensureSet(_$[$0-2], $$[$0-2]), $$[$0]); 
break;
case 156:
 this.$ = p.parseBlock(this._$, p.ensureSet(_$[$0-2], $$[$0-2]), p.ensureSet(_$[$0], $$[$0])); 
break;
case 157:
 this.$ = p.parseAnonFunc(this._$, $$[$0-1], p.ensureBlock(_$[$0], $$[$0], null, false)); 
break;
case 158:
 this.$ = p.parseAnonFunc(this._$, $$[$0-3], p.ensureBlock(_$[$0-2], $$[$0-2], $$[$0], false)); 
break;
case 159:
 this.$ = p.parseAnonFunc(this._$, $$[$0-3], p.ensureBlock(_$[$0-2], $$[$0-2], p.ensureSet(_$[$0], $$[$0]), false)); 
break;
case 160: case 231:
...
break;
case 168:
 this.$ = p.ensureBlock(this._$, p.parseIs(this._$, $$[$0-6], $$[$0-4], $$[$0-2]), $$[$0]); 
break;
case 169:
...
break;
case 172:
 this.$ = p.ensureBlock(this._$, p.parseIs(this._$, $$[$0-10], $$[$0-7], $$[$0-3]), $$[$0]); 
break;
case 173:
...
break;
case 177:
 this.$ = p.parseTransform(this._$, p.parseTransformPair($$[$0-1], $$[$0])); 
break;
case 178:
 this.$ = $$[$0-4]; this.$.addPair(p.parseTransformPair($$[$0-1], $$[$0])); 
break;
case 179:
