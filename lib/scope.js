...
Scope.prototype = {
    ...
    storeVariableValue: function(compiler, name, rhs, loc) {
    },
...
FunctionScope.prototype = fool.subclass(Scope, {
    ...
    assign: function(name, rhs, builder, loc) {
        this.storeVariable(name, rhs, builder, loc);
    },
    ...
    storeVariableValue: function(compiler, name, rhs, loc) {
        var type = this.lookupVariableType(name);
        if (!type) {
            type = rhs.type;
        }
        var cast = type.valueToType(rhs, compiler, loc);
        return this.storeVariable(name, cast, compiler.builder, loc);
    },
