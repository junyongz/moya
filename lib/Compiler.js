...
Compiler.prototype = {
    ...
    compileProgram: function(moduleName, sourcePath, source, debugMode) {
        ...
        try {
            ...
            if (debugMode == "ast") {
                ...
                this.compileModule(moduleName, sourcePath, source, ast);
                this.compileMain();
    ...
    compileModule: function(moduleName, sourcePath, source, ast) {
        ...
        mod = new Module(moduleName, sourcePath, source);
    ...
    compileImport: function(moduleName, sourcePath) {
        ...
        var ast = parser.parse(source);
        return this.compileModule(moduleName, sourcePath, source, ast);
    },
    
    findModule: function(modulePath) {
        return this.tryModulePaths(modulePath, function(fullPath) {
    ...
    tryModulePaths: function(modulePath, cb) {
        if (modulePath[0] == '.') {
            return cb(path.resolve(modulePath));
        } else {
