...
Compiler.prototype = {
    ...
    compileProgram: function(moduleName, sourcePath, source) {
        var progMod = this.createModule(moduleName || "none", sourcePath, source);
        try {
    ...
    callFunction: function(name, args, argSymbols, loc) {
        ...
        if (func) {
            ...
            return this.builder.call(func, castArgs, null, loc);
        }
    },
    ...
    callMethod: function(object, name, args, argSymbols, loc) {
        ...
        if (func) {
            ...
            return this.builder.call(castMethod, castArgs, func.type.returnType, loc);
        }
    },
