...
function NumberType(name, native) {
    ...
    this.class = new GenericClass(name, builtinModule);
    this.native = native;
    this.size = name == 'Void' ? 0 : llvm.getTypeSize(native);
    this.base = null;
}
...
NumberType.prototype = fool.subclass(Type, {
    ...
    isTypeOrSubclass: function(other) {
        return other.isNumber == true || other instanceof PointerType;
    },
});

// *************************************************************************************************

function SequenceType(name, native) {
    this.name = name;
    this.class = new GenericClass(name, builtinModule);
    this.native = native;
...
function PointerType(name, native) {
    this.name = name;
    this.class = new GenericClass(name, builtinModule);
    this.native = native;
    this.size = llvm.getTypeSize(native);
...
var I1 = exports.I1 = new NumberType('Int1', llvm.getType(1));
...
var STRING = exports.STRING = new SequenceType('String', llvm.getType(8));
var POINTER = exports.POINTER = new PointerType('Pointer', llvm.getPointerType(I8.native));
var VTABLEPOINTER = exports.VTABLEPOINTER = new PointerType('VTablePointer', llvm.getType(9));
