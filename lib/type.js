...
Type.prototype = {
    ...
    valueToType: function(value, compiler) {
        if (value.type == this) {
            return value;
        } else {
    ...
    valueToString: function(value, compiler) {
        throw new MoyaError('Unable to convert to string');
    },
...
NumberType.prototype = fool.subclass(Type, {
    ...
    valueToType: function(value, compiler) {
        if (value.type == this) {
            ...
            return compiler.compileTruthTest(value);
        } else if (value.type instanceof NumberType) {
            return compiler.builder.numCast(value, this);
            ...
            return this.valueToType(extracted, compiler);
        } else {
            throw new MoyaError("Illegal cast");
        }
    },
    ...
    valueToString: function(value, compiler) {
        if (this == CHAR) {
            return compiler.builder.call(compiler.charToString, [value]);
        } else if (this == I1) {
            return compiler.builder.call(compiler.boolToString, [value]);
        } else if (this == I8 || this == I16 || this == I32) {
            return compiler.builder.call(compiler.intToString, [I64.valueToType(value, compiler)]);
        } else if (this == I64) {
            return compiler.builder.call(compiler.intToString, [value]);
        } else if (this == F32) {
            return compiler.builder.call(compiler.doubleToString,
                                         [F64.valueToType(value, compiler)]);
        } else if (this == F64) {
            return compiler.builder.call(compiler.doubleToString, [value]);
        } else {
            throw new MoyaError("Illegal string conversion");
        }
    },
...
ClassType.prototype = fool.subclass(Type, {
    ...
    valueToType: function(value, compiler) {
        if (value.type == this) {
            ...
            return compiler.builder.bitCast(value, this);
        } else if (value.type instanceof OptionalType) {
            // XXXjoe Soon to be illegal
            var extracted = compiler.builder.extractValue(value, 0, value.type.type, 'opt');
            return this.valueToType(extracted, compiler);
    ...
    valueToString: function(value, compiler) {
        // XXXjoe Temporary
        return compiler.builder.string(this.toString());
    },
...
PointerType.prototype = fool.subclass(Type, {
    ...
    valueToType: function(value, compiler) {
        if (value.type == this) {
            ...
            return value.valueToString(compiler);
        } else if (value.type instanceof OptionalType) {
            // XXXjoe Soon to be illegal
            var extracted = compiler.builder.extractValue(value, 0, value.type.type, 'opt');
            return this.valueToType(extracted, compiler);
...
OptionalType.prototype = fool.subclass(Type, {
    ...
    valueToType: function(value, compiler) {
        if (value.type == this) {
            ...
            var cast = this.type.valueToType(value, compiler);
            return compiler.builder.optional(cast, this);
        } else {
            throw new MoyaError("Illegal cast");
        }
    },
    ...
    valueToString: function(value, compiler) {
        var passed = compiler.compileTruthTest(value);
        return compiler.compileSingleChoice(compiler.compileTruthTest(value),
            function(compiler) {
                var extracted = compiler.builder.extractValue(value, 0, value.type.type, 'opt');
                return extracted.valueToString(compiler);
            },
            function(compiler) {
