...
Type.prototype = {
    ...
    typeInfo: function(builder) {
        if (!this.typeInfoVar) {
            this.typeInfoVar = this.getTypeInfo(builder);
        }
        return this.typeInfoVar;
    },
    
    getTypeInfo: function(builder) {
...
NumberType.prototype = fool.subclass(Type, {
    ...
    getTypeInfo: function(builder) {
        if (this == I1 || this == BOOL) {
            return builder.global('_ZTIb', POINTER);
        } else if (this == I8 || this == CHAR) {
            return builder.global('_ZTIc', POINTER);
        } else if (this == I8) {
            return builder.global('_ZTIc', POINTER);
        } else if (this == I16) {
            return builder.global('_ZTIs', POINTER);
        } else if (this == I32) {
            return builder.global('_ZTIi', POINTER);
        } else if (this == I64) {
            return builder.global('_ZTIx', POINTER);
        } else if (this == F32) {
            return builder.global('_ZTIf', POINTER);
        } else if (this == F64) {
            return builder.global('_ZTId', POINTER);
        } else {
            throw new MoyaError("No type info");
        }
    },
...
PointerType.prototype = fool.subclass(Type, {
    ...
    getTypeInfo: function(builder) {
        if (this == POINTER) {
            return builder.global('_ZTIPc', POINTER);
        } else if (this == STRING) {
            return builder.global('_ZTIPc', POINTER);
        } else {
            return builder.global('_ZTIPc', POINTER);
