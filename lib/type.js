...
Type.prototype = {
    ...
    getTypeInfo: function(compiler) {
        ...
        var d = compiler.builder.struct(TYPEINFO, [compiler.builder.string(name)]);
    ...
    storeProperty: function(compiler, object, name, rhs, loc) {
