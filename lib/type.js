...
Type.prototype = {
    ...
    construct: function(builder, loc) {
        return this.defaultValue(builder, loc);
    },

    defaultValue: function(builder, loc) {
        throw new MoyaError("Type must be initialized", loc);
    },
...
NumberType.prototype = fool.subclass(Type, {
    ...
    defaultValue: function(builder, loc) {
        if (this == F32) {
            return builder.float32(0, loc);
        } else if (this == F64) {
            return builder.float64(0, loc);
        } else {
            return builder.int(0, this.bitSize, loc);
        }
    },
...
ClassType.prototype = fool.subclass(Type, {
    ...
    construct: function(builder, loc) {
        var objectSize = builder.sizeOfObject(this);
        var raw = builder.call(builder.newObject, [objectSize], null, loc);
        return builder.bitCast(raw, this, loc);
    },
    
    defaultValue: function(builder, loc) {
        return builder.bitCast(builder.int(0, this.bitSize), this, loc);
    },
...
StringType.prototype = fool.subclass(PointerType, {
    toString: function() {
        return this.type + '*';
    },
    ...
    loadProperty: function(compiler, object, propertyName, loc) {
        if (propertyName == "length") {
            return compiler.call(compiler.strlen, [object]);
        } else {
            throw new MoyaError('Property not found', loc);
        }
    },
...
var STRING = exports.STRING = new StringType();
