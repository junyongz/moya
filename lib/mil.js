...
Node.prototype = {
    ...
    valueToString: function(compiler) {
        return this.type.valueToString(this, compiler);
    },
...
exports.Optional.prototype = fool.subclass(Expression, {
    ...
    generate: function(builder) {
        ...
        var value = this.hasValue
            ? this.value.compile(builder)
            : this.type.type.defaultValue(builder).compile(builder);
