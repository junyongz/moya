...
Node.prototype = {
    ...
    compile: function(builder) {
        ...
        if (builder.shouldDebug && this.loc && builder.diunit) {
            llvm.setDebugLocation(this.loc.first_line, this.loc.first_column, builder.diunit);
        }
...
exports.InstanceFunction.prototype = fool.subclass(Expression, {
    ...
    generateFunc: function(builder) {
        if (builder.shouldDebug) {
            this.diunit = llvm.createDebugFunction(this.name, this.func.module.diunit, this.native, 0, this.func.loc.first_line);
